...
public class LogAspect {
    ...
    //@Around("@annotation(com.baizhi.bqs.annotation.AddLog)")
    ...
    //@Around("execution(* com.baizhi.bqs.serviceImpl.*.*(..) ) && !execution(* com.baizhi.bqs.serviceImpl.*.query*(..))")
