...
import com.baizhi.bqs.repository.VideoRepository;
import com.baizhi.bqs.service.VideoService;
import com.baizhi.bqs.util.AliyunOssUtil;
import com.baizhi.bqs.util.InterceptVideoPhotoUtil;
...
public class VideoServiceImpl implements VideoService {
    ...
    public void uploadVdieo(MultipartFile path, String id, HttpServletRequest request) {
         ...
         * */
        AliyunOssUtil.uploadFileBytes("yingx3",path,"video/"+newName);


        //频接视频完整路径
        String netFilePath="https://yingx3.oss-cn-beijing.aliyuncs.com/video/"+newName;
         ...
         * */
        AliyunOssUtil.uploadFile("yingx3","photo/"+coverName,coverPath);
        ...
        video.setPath("https://yingx3.oss-cn-beijing.aliyuncs.com/video/"+newName);
        video.setCover("https://yingx3.oss-cn-beijing.aliyuncs.com/photo/"+coverName);
    ...
    public void uploadVdieos(MultipartFile path, String id, HttpServletRequest request) {
         ...
         *   coverName：截取的封面名
         * */
        AliyunOssUtil.videoCoverIntercept("yingx3","video/"+newName,"photo/"+coverName);
    ...
    public HashMap<String, Object> delete(Video video) {
        ...
        try {
             ...
             * */
            AliyunOssUtil.delete("yingx3",videoName);
             ...
             *   fileName:文件名    目录名/文件名
             * */
            AliyunOssUtil.delete("yingx3",coverName);
    ...
    public List<Video> querySearchs(String content) {
        System.out.println("SSSSS111content = " + content);
        //处理高亮的操作
        ...
        System.out.println("2222videoList.getContent() = " + videoList.getContent());
