...
public class aliyunTests {
    ...
    public void createBucket() {
        ...
        String localFile = "C:\\Users\\HP\\Desktop\\img\\2019-12-23\\213188500.jpg";
        // 创建OSSClient实例。
    ...
    public void  uploadAliyun() {
        ...
        String accessKeySecret = "2xzuEZoU2hqHEfLNULP2rpjODl59zt";
        String bucketName = "yingx3";  //存储空间名
        String objectName = "phonos\\一线基层干部.mp4";  //文件名  可以指定文件目录
        String localFile = "D:\\爸爸\\爸爸.mp4";  //本地视频路径
    ...
    public void deleteFile(){
        ...
        String accessKeySecret = "2xzuEZoU2hqHEfLNULP2rpjODl59zt";
        String bucketName = "yingx3";  //存储空间名
        String objectName = "photos/背影.jpg";  //文件名
