...
<script>
    ...
    function pageInit(){
        ...
        //父表格分页工具栏
        $("#cateTable").jqGrid('navGrid', '#catePage', {add : true,edit : true,del : true,addtext:"添加",edittext:"修改",deltext:"删除"},
            {closeAfterEdit:true},
            {closeAfterAdd:true},
            {
    ...
    function addSubGrid(subgridId, rowId){
        ...
        //子表格分页工具栏
        $("#" + subgridTableId).jqGrid('navGrid',"#" + pagerId, {add : true,edit : true,del : true,addtext:"添加",edittext:"修改",deltext:"删除"},
            {closeAfterEdit:true},
            {closeAfterAdd:true},
            {
                closeAfterDel:true,  //关闭对话框
